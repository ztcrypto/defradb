...
test\:changes:
	@$(MAKE) deps:lens
	env DEFRA_DETECT_DATABASE_CHANGES=true DEFRA_TARGET_BRANCH=1672-assert-true-chd-db-close-2 gotestsum ./tests/integration/query/one_to_one --run TestQueryOneToOneWithGroupRelatedIDFromSecondary -shuffle=on -p 1
